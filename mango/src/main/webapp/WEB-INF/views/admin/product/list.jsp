...
$(function() {
	$("body").on("click",".myBtnArticle", function() {
		var pNum = $(this).closest("tr").attr("data-bbsNum");
		var pcNum = $(this).closest("tr").attr("data-catNum");
		var query = "pNum="+pNum+"&pcNum="+pcNum+"&page=1";
		
		var url = "${pageContext.request.contextPath}/product/article";
		url += "?" + query;
...
$(function() {
	$("body").on("click",".myBtnRefresh", function() {
		var url = "${pageContext.request.contextPath}/admin/product/list";
...
$(function() {
	$("body").on("click",".myBtnClear", function() {
		...
		var url = "${pageContext.request.contextPath}/admin/product/clear";
...
<main>
	...
	<div class="body-container">
	    <div class="body-title">
			<h2><i class="icofont-interface"></i> 중고물품 신고관리 </h2>
	    </div>
