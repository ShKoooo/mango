...
$(function() {
	$("body").on("click",".btn-delete", function() {
		var delConfStr = $(this).closest("tr").attr("data-keyword")+" 님을 차단유저 목록에서 삭제하시겠습니까?";
		var seqNum = $(this).closest("tr").attr("data-num");
		var tableName = "blockedUser";
		...
		<div class="inner-container container">
			...
			<div class="container">			
				<div class="row mb-3">
					<div class="col-md-7">
						<h4>
							<i class="icofont-not-allowed"></i> 차단 유저 목록
						</h4>
					</div>
					<div class="col-md-5 text-right">
						<form name="searchForm" action="${pageContext.request.contextPath}/mypage/myblock">
				...
				<c:if test="${empty myBlockedUserList}">
					<div class="border bg-light mb-3 p-3 text-center">
						차단한 유저가 없습니다.
					</div>
				</c:if>
				<c:if test="${not empty myBlockedUserList}">
					<div class="row mb-3 mx-3">
						<table class="table">
							...
							<tbody>
								<c:forEach var="dto" items="${myBlockedUserList}">
									<tr data-num="${dto.blockNum}" data-keyword="${dto.userNickName}">
				...
				<div class="row">
					<div class="col-md-5">
						<form name="insertForm" action="${pageContext.request.contextPath}/mypage/insertBlockedUser">
							<input type="text" name="keyword" value="${keyword}" class="boxTF" placeholder="닉네임">&nbsp;
