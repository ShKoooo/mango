			...
			<div class="box-content">
				...
				<div class="row board-list-footer">
					...
					<div class="col-6 text-center">
						<form class="row" name="searchVillageForm" action="${pageContext.request.contextPath}/village/news/list" method="post"
							style="width: 600px;">
					...
					<div class="col text-end">
						<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/news/write';">글쓰기</button>
					</div>
				</div>
			</div>
		</div>
