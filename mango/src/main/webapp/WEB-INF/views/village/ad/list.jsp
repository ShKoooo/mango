			...
			<div class="box-content">
				...
				<div class="row board-list-footer">
					...
					<div class="col-6 text-center">
						<form class="row" name="searchVillageForm" action="${pageContext.request.contextPath}/village/ad/list" method="post"
							style="width: 600px;">
					...
					<div class="col text-end">
						<c:if test = "${!empty businessAddr.membershipNum}">
						<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/ad/write';">글쓰기</button>
						</c:if>					
					</div>
				</div>
			</div>
