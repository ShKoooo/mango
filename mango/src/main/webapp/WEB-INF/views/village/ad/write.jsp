...
function sendOk() {
	...
	f.action = "${pageContext.request.contextPath}/village/ad/${mode}";
	f.submit();
			...
			<div class="box-content">
				...
				<form name="adForm" method="post" enctype="multipart/form-data">
					<table class="table write-form mt-5">
						...
						<tr>
							<td class="table-light  col-2" scope="row">가게 주소</td>
							<td class="col-6">
									${businessAddr.busAddr1}&nbsp;${businessAddr.busAddr2}
							</td>
						</tr>
						</c:if>
						<tr>
						...
						<tr>
							...
							<td>
								<p class="form-control-plaintext">${businessAddr.busNickName}</p>
							</td> 
						</tr>
						</c:if>
						<tr>
					...
					<table class="table table-borderless">
						<tr>
							<td class="text-center">
								...
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/ad/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
