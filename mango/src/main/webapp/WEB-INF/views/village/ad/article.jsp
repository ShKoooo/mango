...
<c:if test="${sessionScope.member.userId==dto.userId||sessionScope.member.membership>50}">
	function deleteBoard() {
		if(confirm("게시글을 삭제하시겠습니까?")) {
			...
			var url = "${pageContext.request.contextPath}/village/ad/delete?" + query;
			location.href = url;
		}
	}
</c:if>
...
$(function() {
	$(".btnSendBoardLike").click(function() {
		...
		var url="${pageContext.request.contextPath}/village/ad/insertBoardLike";
		var vNum="${dto.vNum}";
...
function listPage(page) {
	var url = "${pageContext.request.contextPath}/village/ad/listReply";
...
$(function() {
	$(".btnSendReply").click(function() {
		...
		var url = "${pageContext.request.contextPath}/village/ad/insertReply";
...
$(function() {
	$("body").on("click", ".deleteReply", function() {
		...
		var url = "${pageContext.request.contextPath}/village/ad/deleteReply";
...
$(function() {
	...
	$("body").on("click", ".btnSendReplyLike", function() {
		...
		var url = "${pageContext.request.contextPath}/village/ad/insertReplyLike";
...
function listReplyAnswer(vrAnswer) {
	var url ="${pageContext.request.contextPath}/village/ad/listReplyAnswer";
...
function countReplyAnswer(vrAnswer) {
	var url="${pageContext.request.contextPath}/village/ad/countReplyAnswer";
	var query = "vrAnswer="+vrAnswer;
...
function sendReport() {
	if(confirm("한 번 신고한 상품/게시물은 신고를 철회할 수 없습니다.\n정말 신고하시겠습니까?")) {
		...
		f.action = "${pageContext.request.contextPath}/village/ad/report?" + query;
		f.submit();
				...
				<div class="body-main">
					...
					<table class="table mb-0">
						...
						<tbody>
							<tr>
								<td width="50%">
								<img class="rounded-circle profileImg" src="https://dummyimage.com/20x20/ced4da/6c757d" alt="..." style="float: left; margin-right: 10px"/> <b> ${businessAddr.busNickName} </b>
								</td>
								<td align="right">
					...
					<table class="table table-borderless mb-2">
						<tr>
							<td width="50%">
								<c:choose>
									<c:when test="${sessionScope.member.userId==dto.userId}">
										<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/ad/update?vNum=${dto.vNum}&page=${page}';">수정</button>
									</c:when>
								</c:choose>
							...
							<td class="text-end">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/ad/list';">리스트</button>
							</td>
						</tr>
					</table>
...
function sendReplyReport() {
	if(confirm("한 번 신고한 댓글은 신고를 철회할 수 없습니다.\n정말 신고하시겠습니까?")) {
		...
		f.action = "${pageContext.request.contextPath}/village/ad/reportReply";
