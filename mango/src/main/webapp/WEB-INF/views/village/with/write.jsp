...
function sendOk() {
	...
	f.action = "${pageContext.request.contextPath}/village/with/${mode}";
	f.submit();
	...
	<div class="projects-holder">
		<div class="col-12">
			<div class="box-content">
				...
				<div class="body-main">
				<form name="withForm" method="post" enctype="multipart/form-data">
					...
					<table class="table table-borderless">
						<tr>
							<td class="text-center">
								...
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/with/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
