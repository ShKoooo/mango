...
<c:if test="${sessionScope.member.userId==dto.userId||sessionScope.member.membership>50}">
	function deleteBoard() {
		if(confirm("게시글을 삭제하시겠습니까?")) {
			...
			var url = "${pageContext.request.contextPath}/village/lost/delete?" + query;
			location.href = url;
		}
	}
</c:if>
...
$(function() {
	$(".btnSendBoardLike").click(function() {
		...
		var url="${pageContext.request.contextPath}/village/lost/insertBoardLike";
		var vNum="${dto.vNum}";
...
function listPage(page) {
	var url = "${pageContext.request.contextPath}/village/lost/listReply";
...
$(function() {
	$(".btnSendReply").click(function() {
		...
		var url = "${pageContext.request.contextPath}/village/lost/insertReply";
...
$(function() {
	$("body").on("click", ".deleteReply", function() {
		...
		var url = "${pageContext.request.contextPath}/village/lost/deleteReply";
...
$(function() {
	...
	$("body").on("click", ".btnSendReplyLike", function() {
		...
		var url = "${pageContext.request.contextPath}/village/lost/insertReplyLike";
...
function listReplyAnswer(vrAnswer) {
	var url ="${pageContext.request.contextPath}/village/lost/listReplyAnswer";
...
function countReplyAnswer(vrAnswer) {
	var url="${pageContext.request.contextPath}/village/lost/countReplyAnswer";
	var query = "vrAnswer="+vrAnswer;
...
function sendReport() {
	if(confirm("한 번 신고한 상품/게시물은 신고를 철회할 수 없습니다.\n정말 신고하시겠습니까?")) {
		...
		f.action = "${pageContext.request.contextPath}/village/lost/report?" + query;
		f.submit();
				...
				<div class="body-main">
					...
					<table class="table table-borderless mb-2">
						<tr>
							<td width="50%">
								<c:choose>
									<c:when test="${sessionScope.member.userId==dto.userId}">
										<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/lost/update?vNum=${dto.vNum}&page=${page}';">수정</button>
									</c:when>
								</c:choose>
							...
							<td class="text-end">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/village/lost/list';">리스트</button>
							</td>
						</tr>
					</table>
...
function sendReplyReport() {
	if(confirm("한 번 신고한 댓글은 신고를 철회할 수 없습니다.\n정말 신고하시겠습니까?")) {
		...
		f.action = "${pageContext.request.contextPath}/village/lost/reportReply";
