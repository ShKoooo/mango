		...
		<form name="loginForm" method="post">
			<div class="members-form">
				...
				<div class="row">
					...
					<input name="userId" type="text" class="boxTF" id="login-userId" placeholder="아이디">
				</div>
				<div class="row">
					<label for="login-password">Your Password</label>
					<input name="userPwd" type="password" class="boxTF" id="login-password" placeholder="패스워드">
				</div>
				<div class="row text-center">
					<button type="button" class="btn btn-primary" onclick="sendLogin();">Login</button>
				</div>
				<p class="text-center">
					<a href="${pageContext.request.contextPath}/member/member">회원가입</a> <span>|</span>
